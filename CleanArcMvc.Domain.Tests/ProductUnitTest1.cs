...
public class ProductUnitTest1
{
    ...
    {
        Action action = () => new Product(1, "Product Name", "Description", 0, 0, "");
        action.Should()
    ...
    {
        Action action = () => new Product(1, null, "Description", 0, 0, "");
        action.Should()
            .Throw<CleanArcMvc.Domain.Validation.DomainExceptionValidation>()
    ...
    {
        Action action = () => new Product(1, "", "Description", 0, 0, "");
        action.Should()
            .Throw<CleanArcMvc.Domain.Validation.DomainExceptionValidation>()
            .WithMessage("Invalid name. Name is required");
    }
    ...
    {
        Action action = () => new Product(1, "Product Name", null, 0, 0, "");
        action.Should()
            .Throw<CleanArcMvc.Domain.Validation.DomainExceptionValidation>()
    ...
    {
        Action action = () => new Product(1, "Product Name", "", 0, 0, "");
        action.Should()
            .Throw<CleanArcMvc.Domain.Validation.DomainExceptionValidation>()
            .WithMessage("Invalid description. Description is required");
    }
    ...
    {
        Action action = () => new Product(1, "Product Name", "Description", -1, 0, "");
        action.Should()
            .Throw<CleanArcMvc.Domain.Validation.DomainExceptionValidation>()
    ...
    {
        Action action = () => new Product(1, "Product Name", "Description", 0, -1, "");
        action.Should()
            .Throw<CleanArcMvc.Domain.Validation.DomainExceptionValidation>()
    ...
    {
        Action action = () => new Product(1, "Product Name", "Description", 0, 0, null);
        action.Should()
            .NotThrow<CleanArcMvc.Domain.Validation.DomainExceptionValidation>();
    }
